  ...
  <div style="margin:auto; width:1100px; height:100%; min-height: 800px;">
    ...
    <div style="float:right; width:915px; height: auto;">
        ...
        <div style="float: left;">
          <div class="input-group mb-3" style="width: 300px; float: left; margin-right: 10px;">
            <input type="text" class="form-control keyword" placeholder="검색할 단어를 입력하세요"
              aria-label="Recipient's username" aria-describedby="button-addon2" style="border:1px solid #ededed;">
          ...
          <div class="card" style="width: 18rem;margin-bottom: 15px; display: inline-block; margin-left:10px; ">
            ...
            <div style="padding: 10px;">
              ...
              <input id="test" type="checkbox" name="checkbox_check" class="ckbox"
                ...
                value="${board.w_seq}">
              <a href="<%=request.getContextPath()%>/board/detail.do?pd_seq=${board.pd_seq }"
      ...
      <div style="margin: auto; width: 240px; margin-bottom: 40px;">
        <ul class="pagination">
          <li class="page-item">
            <a class="page-link" href="#" aria-label="Previous" style="color: gray; border:1px solid #ededed">
              <span aria-hidden="true">&laquo;</span>
              <!-- <span class="sr-only">Previous</span> -->
            </a>
          </li>
          <li class="page-item"><a class="page-link" href="#" style="color: gray;border:1px solid #ededed">1</a></li>
          <li class="page-item"><a class="page-link" href="#" style="color: gray;border:1px solid #ededed">2</a></li>
          <li class="page-item"><a class="page-link" href="#" style="color: gray;border:1px solid #ededed">3</a></li>
          <li class="page-item"><a class="page-link" href="#" style="color: gray;border:1px solid #ededed">4</a></li>
          <li class="page-item"><a class="page-link" href="#" style="color: gray;border:1px solid #ededed">5</a></li>
          <li class="page-item">
            <a class="page-link" href="#" aria-label="Next" style="color: gray;border:1px solid #ededed">
