...
<%}%> -->
    ...
    <div style="margin:auto; width:1100px; height:800px;">
        <div style="float:left;width:180px; height:600px; ">
            ...
            <div class="myPageMenu" id="myPageQuediv1"><a href='<%=request.getContextPath() %>/myPage/list.do'>1대1문의</a>
            </div>
            <div class="myPageMenu" id="myPageWishdiv1"><a
                    href="<%=request.getContextPath() %>/wishlist/list.do?u_id=${member.u_id}">찜 내역</a></div>
                ...
                <table id="myPageinfoTab2" style="width:900px;">
                    <tr>
                        <td style="height: 300px; width: 40%; text-align: center;">
                            <div
                                style="margin: auto; width:100px;height:100px; background-color: #ededed; border-radius: 50px; text-align: center; line-height: 100px; box-shadow: 0 0 10px #ededed; font-size: 120%;">
                                ${member.u_nickName }</div>
                            <div>고객님 안녕하세요!</div>
                        </td>
                        <td>
                            <div style="margin: auto; width: 100%;  text-align: center;">
                                <input type="button" value="회원정보 변경"
                                    onclick="location.href='<%=request.getContextPath() %>/user/modifyInfoPass.do'">
