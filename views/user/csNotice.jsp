...
<body>
    ...
    <div style="margin:auto; width:1100px; min-height: 800px;">
        <div class="list-group" id="leftSlide01"
            ...
            <a href="http://localhost:8088/trip/user/cs.do" class="list-group-item list-group-item-action"
            ...
            <a href="<%=request.getContextPath() %>/user/csOften.do" class="list-group-item list-group-item-action">자주하는질문</a>
