...
<body>
      ...
      <tr>
        <td>
          <div>
            ...
            <div class="input-group-text" style="margin-bottom: 40px; border:0; height: 45px;">
              <label for="defaultCheck0"><input class="form-check-input" name="agree_all" type="checkbox" value=""
                  id="defaultCheck0" aria-label="Checkbox for following text input"> 전체 동의</label>
            </div>
            <div class="form-check">
              ...
              <div style="float: right;"><a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop0">약관확인</a>
                &raquo;</div>
            </div>
            <div class="form-check">
              <input class="form-check-input" name="agree" type="checkbox" value="" id="defaultCheck3">
              <label class="form-check-label" for="defaultCheck3">
                OneTrillion 이용안내<strong>(필수)</strong>
              </label>
              <div style="float: right;"><a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop2">약관확인</a>
                &raquo;</div>
            </div>
            <div class="form-check">
              <input class="form-check-input" name="agree" type="checkbox" value="" id="defaultCheck2">
              <label class="form-check-label" for="defaultCheck2">
                개인정보 수집, 이용, 제공에 대한안내<strong>(필수)</strong>
              </label>
              <div style="float: right;"><a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">약관확인</a>
                &raquo;</div>
            </div>
            <p style="margin-bottom: 40px; font-size: 80%;">*개인정보의 수집,제공및 활용에 동의하지 않을 권리가 있으며, 미동의시 회원가입및 여행서비스 제공이
              제한됩니다.</p>
            <button type="button" class="btn btn-dark" onclick="agreePass()">동의합니다</button><button type="button"
              class="btn btn-secondary btn-secondary2" onclick="location.href='login.do'">동의하지 않습니다</button>
          </div>
        </td>
      </tr>
    </table>
          ...
          <div id="tripAgFdiv02" style="margin: auto; width: 100%;">
            ...
            <ol class="list_number">
              <li>여행자가 인터넷 등 전자정보망으로 제공된 여행계약서, 약관 및 여행일정표(또는 여행설명서)의 내용에
                동의하고 여행계약의 체결을 신청한 데 대해 여행사가 전자정보망 내지 기계적 장치 등을 이용하여 여행자에게 승낙의
                의사를 통지한 경우</li>
            ...
            <ol class="list_nostyle">
              ...
              <li>② 여행사가 계약서 등에 명시된 여행일정을 변경하는 경우에는 해당 날짜의 일정이 시작되기 전에
                여행자의 서면 동의를 받아야 합니다. 이때 서면동의서에는 변경일시, 변경내용, 변경으로 발생하는 비용이 포함되어야
                합니다.</li>
              ...
              <li>④ 제1항의 여행조건 변경으로 인하여 제9조제1항의 여행요금에 증감이 생기는 경우에는 여행출발 전
                변경 분은 여행출발 이전에, 여행 중 변경 분은 여행종료 후 10일 이내에 각각 정산(환급)하여야 합니다.</li>
              <li>⑤ 제1항의 규정에 의하지 아니하고 여행조건이 변경되거나 제13조 내지 제15조의 규정에 의한
                계약의 해제․해지로 인하여 손해배상액이 발생한 경우에는 여행출발 전 발생 분은 여행출발이전에, 여행 중 발생 분은
            ...
            <ol class="list_nostyle">
              <li>① 여행자가 개인사정 등으로 여행자의 지위를 양도하기 위해서는 여행사의 승낙을 받아야 합니다. 이때
                여행사는 여행자 또는 여행자의 지위를 양도받으려는 자가 양도로 발생하는 비용을 지급할 것을 조건으로 양도를 승낙할
                수 있습니다.</li>
            ...
            <ol class="list_nostyle">
              ...
              <li>④ 여행사는 여행 출발시부터 도착시까지 여행사 본인 또는 그 고용인, 현지여행사 또는 그 고용인
                등(이하 ‘사용인’이라 함)이 제3조제1항에서 규정한 여행사 임무와 관련하여 여행자에게 고의 또는 과실로 손해를
                가한 경우 책임을 집니다.</li>
              <li>⑤ 여행사는 항공기, 기차, 선박 등 교통기관의 연발착 또는 교통체증 등으로 인하여 여행자가 입은
                손해를 배상하여야 합니다. 다만, 여행사가 고의 또는 과실이 없음을 입증한 때에는 그러하지 아니합니다.</li>
              <li>⑥ 여행사는 자기나 그 사용인이 여행자의 수하물 수령․인도․보관 등에 관하여 주의를 해태하지
                아니하였음을 증명하지 아니 하는 한 여행자의 수하물 멸실, 훼손 또는 연착으로 인하여 발생한 손해를 배상하여야
                합니다.</li>
            </ol>
                ...
                <ol class="list_number">
                  <li>여행사가 해제할 수 있는 경우
                    <ol class="list_nostyle">
                      ...
                      <li>나. 여행자가 다른 여행자에게 폐를 끼치거나 여행의 원활한 실시에 현저한 지장이 있다고
                        인정될 때</li>
                  ...
                  <li>여행사가 해제할 수 있는 경우
                    <ol class="list_nostyle">
                      <li>가. 제10조 제1항 제1호 및 제2호 사유의 경우</li>
                      <li>나. 여행사가 제18조에 따른 공제 또는 보증보험에 가입하지 아니 하였거나 영업보증금을
                        예치하지 않은 경우</li>
                      <li>다. 여행자의 3촌이내 친족이 사망한 경우</li>
                      <li>라. 질병 등 여행자의 신체에 이상이 발생하여 여행에의 참가가 불가능한 경우</li>
                      <li>마. 배우자 또는 직계존비속이 신체이상으로 3일 이상 병원(의원)에 입원하여 여행 출발시까지
                        퇴원이 곤란한 경우 그 배우자 또는 보호자 1인</li>
                      <li>바. 여행사의 귀책사유로 계약서에 기재된 여행일정대로의 여행실시가 불가능해진 경우</li>
                    </ol>
                  </li>
                </ol>
              </li>
            ...
            <ol class="list_nostyle">
              <li>① 여행사는 최저행사인원이 충족되지 아니하여 여행계약을 해제하는 경우 당일여행의 경우 여행출발
                24시간 이전까지, 1박2일 이상인 경우에는 여행출발 48시간 이전까지 여행자에게 통지하여야 합니다.</li>
            ...
            <ol class="list_nostyle">
              <li>① 여행사 또는 여행자는 여행출발 후 부득이한 사유가 있는 경우 각 당사자는 여행계약을 해지할 수
                있습니다. 다만, 그 사유가 당사자 한쪽의 과실로 인하여 생긴 경우에는 상대방에게 손해를 배상하여야 합니다.</li>
              ...
              <li>⑥ 제4항에 따라 계약이 해지된 경우 여행사는 계약의 해지로 인하여 필요하게 된 조치를 할 의무를
                지며, 계약상 귀환운송 의무가 있으면 여행자를 귀환운송하여야 합니다. 이 경우 귀환운송비용은 원칙적으로 여행사가
                부담하여야 하나, 상당한 이유가 있는 때에는 여행사는 여행자에게 그 비용의 일부를 청구할 수 있습니다.</li>
            </ol>
  ...
  <div class="modal fade" id="staticBackdrop1" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">개인정보 수집, 이용, 제공에 대한안내</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="wrap_agree" style="width: 100%; margin: auto;">
            ...
            <ol class="list_circle">
              ...
              <li><span>②</span> 회사는 개인정보 처리방침을 통하여 이용자의 개인정보를 이용하는 목적과 방법,
                이용자의 개인정보 보호를 위해 취하는 조치를 알려드립니다. 회사는 개인정보 처리방침을 홈페이지 첫 화면에 공개함으로써
                언제나 용이하게 보실 수 있습니다.</li>
              <li><span>③</span> 본 개인정보 처리방침은 정부의 법령 및 지침의 변경, 또는 보다 나은 서비스의
                제공을 위하여 그 내용이 변경될 수 있으며, 회사는 개인정보 처리방침을 개정하는 경우 이용자가 개정된 사항을 쉽게 알아볼
                수 있도록 공지하고 있습니다.</li>
            </ol>
            <h5 class="tit_main_txt">2. 개인정보의 수집항목 및 이용목적</h5>
            <ol class="list_circle">
              <li><span>①</span> 회사는 회원가입 또는 상품의 예약 및 관련 서비스 이용 시 아래의 개인정보 항목을
                다음과 같은 목적으로 수집하고 있습니다. 이용자의 개인정보를 수집하는 경우에는 그 목적에 필요한 최소한의 개인정보를
                수집하고 있습니다.</li>
            </ol>
            ...
            <table class="tbl_vertical">
              ...
              <tbody>
                <tr>
                  ...
                  <td rowspan="2">SNS(Facebook, Kakao, Naver, Apple)를 통한 회원가입
                    서비스 이용 시 제휴사 로부터 제공 받는 정보</td>
                  <td rowspan="2">회원가입 철회 시 까지 또는 법정 의무 보유기간<br> ※ SNS로부터
                    제공받은 정보는 회원가입 단계에서만 이용하며,회원가입이 진행되지 않는 경우 즉시 파기합니다. 또한, 당사의 회원가입
            ...
            <table class="tbl_vertical">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>예약자 : 성명(국문), 생년월일, 성별, 이메일주소, 휴대전화번호,국적, 성명(영문)<br>여행자
                    : 성명(국문),국적, 성명(영문)
                  </td>
                  <td>국내 항공권 예약</td>
                ...
                <tr>
                  <td class="txt_center">필수</td>
                  <td>성명(국문), 생년월일, 카드정보(카드번호, 카드만료일), 환불시(은행명, 계좌번호, 예금주)</td>
                  <td>상품 결제/환불/정산</td>
                </tr>
                <tr>
                  <td class="txt_center">필수</td>
                ...
                <tr>
                  <td class="txt_center">필수</td>
                  <td>예약자 성명(국문), 예약자 생년월일, 예약자 성별, 예약자 휴대전화번호, 성명(영문), 휴대전화번호</td>
                  <td>비회원 상품 예약 시</td>
                </tr>
              </tbody>
            </table>
            ...
            <ol class="list_circle">
              <li><span>①</span> 단, 이용자의 기본적 인권 침해의 우려가 있는 민감한 개인정보 (정치적 성향 및
                범죄기록, 건강상태 등)는 이용자로부터 별도의 동의를 받거나 법률에 근거가 없는 이상 수집하지 않습니다.</li>
              <li><span>②</span> 회사는 이용자에게 재화나 서비스를 홍보하거나 판매를 권유하기 위하여 개인정보의
                처리에 대한 동의를 받으려는 때에는 이용자가 이를 명확하게 인지할 수 있도록 알리고 동의를 받습니다.</li>
              <li><span>③</span> 회사는 모바일 앱 서비스를 위하여 이용자의 이동통신단말기 내 정보 및 기능 중
                아래 사항에 대해 접근을 합니다. 필수 접근항목은 앱 설치 또는 최초실행시 안내 및 동의를 받으며, 선택 접근항목은 해당
                서비스 진입시 별도 동의를 받습니다. 선택 접근항목의 경우 OS버전에 따라 동의 받는 방법이 다를 수 있으나, 이용자가
            ...
            <ol class="list_circle">
              <li><span>①</span> 회사는 적법한 절차와 법적 기준에 의거하여 이용자의 개인정보를 수집하고 있으며,
                이용자의 서비스 이용에 필요한 최소한의 정보만을 수집하며, 관련 법률 및 하위법령에 의거하여 수집, 이용을 제한하고
                있습니다.</li>
              <li><span>②</span> 회사에서 운영하는 홈페이지 회원가입, 모바일 어플리케이션의 가입절차, 상담절차,
                이벤트 및 경품행사, 영업업무 위탁사 또는 제휴사 등의 방법으로 수집하며, 이동 전화 및 유-무선 인터넷 서비스를 사용
            ...
            <ol class="list_circle">
              <li><span>①</span> 이용자의 개인정보는 다음과 같이 개인정보의 수집목적 또는 제공받은 목적 달성 시
                까지 이용하지만, '전자상거래 등에서의 소비자보호에 관한 법률’(이하 ‘전자상거래법’), ‘통신비밀보호법’ 등 관련
                법령의 규정에 의하여 다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을
                경우에는 일정기간 보유합니다.
                <ol class="list_number">
              ...
              <li><span>④</span> 회사는 개인정보보호법 제39조의6에 따라 12개월간 이용내역 (로그인, 주문,
                상담 등)이 없는 회원의 개인정보는 다른 회원의 개인정보와 분리하여 별도로 저장·관리합니다. 회사는 분리 저장된
                개인정보를 법정보관기간 경과 후 파기하며, 이에 따라 회원은 회원자격을 상실 할 수 있습니다. 또한, 분리보관 30일
                전까지 개인정보가 분리되어 저장·관리되는 사실과 기간 만료 일 및 해당 개인정보의 항목을 전자우편·서면·모사전송·전화
            ...
            <ol class="list_circle">
              <li><span>①</span> 회사는 이용자의 개인정보를 <strong>「개인정보의 수집항목
                  및 이용목적」 </strong>에서 고지한 범위 내에서 사용하며, 이용자의 사전 동의 없이 동 범위를 초과하여 이용하거나 원칙적으로
                이용자의 개인정보를 제3자 또는 외부에 제공하지 않습니다. 단, 이용자의 동의가 있거나 법령에 의하여 정해진 절차에 따라
                정보를 요청 받은 경우는 예외로 하며, 이 경우 주의를 기울여 개인정보를 이용 및 제공 할 수 있습니다.</li>
              ...
              <tbody>
                <tr>
                  ...
                  <td rowspan="2">성명(국문/영문), 성별, 생년월일, 여권정보(여권번호, 여권만료일),
                    휴대전화번호, 포인트 정보, 카드정보(카드번호, 카드만료일), 환불 시(은행명, 계좌번호, 예금주)</td>
            ...
            <ol class="list_circle">
              <li><span>①</span> 회사는 서비스 제공에 있어 필요한 업무 중 일부를 아래와 같이 개인정보 처리
                ...
                <table class="tbl_vertical">
                  ...
                  <thead>
                    <tr>
                      <th scope="col" class="txt_center">위탁받는 자(수탁업체)</th>
                      <th scope="col" class="txt_center">위탁업무의 목적(수탁업무 내용)</th>
                      <th scope="col" class="txt_center">개인정보의 보유 및 이용기간</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <td>㈜한진택배</td>
                      <td>- 자유 여행객 서류 및 화물 발송 (항공권, 바우처, 여행자 계약서 등)<br>- 경품
                        발송
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>㈜마이비자코리아, ㈜인스밸리, ㈜와이드모바일, ㈜무브, ㈜엔에이치엔위투, ㈜와그, ㈜미리디,
                        ㈜이브릿지, ㈜케이밴코리아, ㈜아이트립, ㈜플래닛티, ㈜네이처모빌리티, ㈜스마일캣, ㈜동신항운</td>
                      <td>상품 예약, 상담, 결제</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table class="tbl_basic">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>싱가포르 (8 Marina View #13-01A Asia Square Tower 1
                        Singapore 018960)</td>
                    ...
                    <tr>
                      ...
                      <td>성명(국문/영문), 성별, 생년월일, 내/외국인 여부, 휴대전화번호, 이메일주소, OneTrillion 포인트
                        정보</td>
                      <td>성명(국문/영문), 성별, 생년월일, 내/외국인 여부, 휴대전화번호, OneTrillion 포인트 정보</td>
                    </tr>
                    <tr>
                      <th scope="row">위탁업무 내용</th>
                      <td>앱푸시, 웹푸시, 이메일, SMS/LMS, 카카오 친구톡, 알림톡을 통한 마케팅 및 서비스 안내,
                        OneTrillion 할인쿠폰 정보</td>
                      <td>SMS/LMS 카카오 친구톡, 알림톡을 통한 마케팅 및 서비스 안내, OneTrillion 할인쿠폰 정보</td>
                    </tr>
                    <tr>
            ...
            <ol class="list_circle">
              <li><span>①</span> 이용자가 동의하신 내용을 언제든지 철회하거나, 개인정보 삭제 및 처리정지를
                요청할 수 있습니다. 회원은 「마이페이지」 메뉴에서 "회원탈퇴" 를 클릭함으로써 회원 탈퇴를 요청할 수 있으며, 직접
                개인정보 보호책임자에게 서면, 전화, E-mail등으로 연락하시면 본인확인 절차를 거쳐 즉시 회원탈퇴를 위해 필요한
                조치를 하겠습니다.</li>
              ...
              <li><span>④</span> 개인정보 파기의 절차 및 방법은 다음과 같습니다.
                <ol class="list_number">
                  <li>파기절차
                    <ul class="list_nostyle">
                      <li>가. 회사는 파기 사유가 발생한 개인정보를 선정하고, 회사의 개인정보 보호책임자의 승인을 받아
                        개인정보를 파기합니다.</li>
                    </ul>
                  </li>
                  <li>파기방법
                    <ul class="list_nostyle">
                      <li>가. 회사는 전자적 파일 형태로 기록/저장된 개인정보는 기록을 재생할 수 없도록 로우레밸포멧(Low
            ...
            <ol class="list_circle">
              <li><span>①</span> 기술적 대책
                <ol class="list_number">
                  <li>회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 위조•변조 또는 훼손되지
                    않도록 안전성 확보를 위하여 다음과 같은 기술적 대책을 강구하고 있습니다.
                    <ul class="list_nostyle">
                      <li>가. 이용자의 개인정보는 비밀번호에 의해 보호되며 파일 및 전송데이터를 암호화하거나 파일
                        잠금기능(Lock)을 사용하여 중요한 데이터는 별도의 보안기능을 통해 보호되고 있습니다.</li>
                      <li>나. 회사는 백신프로그램을 이용하여 악성코드에 의한 피해를 방지하기 위한 조치를 취하고 있습니다.
                        백신프로그램은 주기적으로 업데이트되며 갑작스런 악성코드가 출현할 경우 백신이 나오는 즉시 이를 제공함으로써
                        개인정보가 침해되는 것을 방지하고 있습니다.</li>
                      <li>다. 회사는 네트워크 상의 개인정보를 안전하게 전송할 수 있는 보안장치(SSL 또는 SET)를
                        채택하고 있습니다.</li>
                      <li>라. 해킹 등 외부침입에 대비하여 네트워크 구간에 침입차단시스템 등을 이용하여 보안에 만전을 기하고
                        있습니다.</li>
                    </ul>
                  </li>
                </ol>
              ...
              <li><span>②</span> 관리적 대책
                <ol class="list_number">
                  ...
                  <li>회사는 이용자 개인의 실수로 일어나는 일들에 대해 책임을 지지 않습니다. 회원 개개인이 본인의
                    개인정보를 보호하기 위해서 자신의 ID 와 비밀번호를 적절하게 관리하고 정기적으로 비밀번호를 변경하는 것이
                    바람직합니다.</li>
            ...
            <ol class="list_circle">
              <li><span>①</span> 회사는 이용자에 대한 정보를 저장하고 수시로 찾아내는 '쿠키(cookie)'를
                사용합니다. 쿠키는 웹사이트가 귀하의 브라우저 (인터넷 익스플로러 등)로 전송하는 소량의 정보입니다. 이용자가 웹사이트에
                접속을 하면 회사는 이용자의 브라우저에 있는 쿠키의 내용을 읽고, 추가정보를 이용자의 컴퓨터 등에서 찾아 성명 등의 추가
                입력 없이 서비스를 제공할 수 있습니다.<br> 또한 이용자는 쿠키에 대한 선택권이 있습니다. 웹브라우저 상단의
                도구 &gt; 인터넷옵션 탭(option tab)에서 모든 쿠키를 다 받아들이거나, 쿠키가 설치될 때 통지를 보내도록
              ...
              <li><span>②</span> 회사는 다음과 같은 목적을 위해 쿠키를 통하여 수집된 이용자의 개인정보를
                ...
                <ol class="list_number">
                  ...
                  <li>여행상품에 대한 정보와 관심있게 둘러본 품목들에 대한 자취를 추적하여 다음 번 쇼핑 때 개인 맞춤
            ...
            <ol class="list_circle">
              ...
              <li><span>⑤</span> 만 14세 이상인 경우에만 회원가입이 가능하며 개인정보의 수집 및 이용에
                법정대리인의 동의가 필요한 만 14세 미만 아동의 개인정보는 원칙적으로 수집하지 않습니다. (만 14세 이상 회원가입정책
            ...
            <ol class="list_circle">
              ...
              <li><span>②</span> 기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기
                바랍니다.
                <ol class="list_number">
                  <li>개인정보분쟁조정위원회(<a href="http://www.kopico.go.kr" target="_blank">www.kopico.go.kr</a> /국번없이 118)
                  </li>
                  ...
                  <li>경찰청 사이버안전국(<a href="http://cyberbureau.police.go.kr" target="_blank">cyberbureau.police.go.kr</a>
                    /국번없이 182)
                  </li>
                </ol>
              </li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div style="width: 100%; margin: auto;">
            ...
            <h4 class="tit_sub">제1조(목적)</h4>
            <ol class="list_circle">
              <li>① 본 약관은 주식회사 OneTrillion(이하 "회사")이 온라인 사이트(이하 "웹사이트") 및 응용프로그램(이하
                "어플리케이션")에서 제공하는 서비스(이하 "서비스")를 이용자(이하 "이용자")가 이용함에 있어 "회사"와 "이용자" 간의
            ...
            <ol class="list_circle">
              <li>① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
                <ol class="list_number">
                  <li>웹사이트: 상품 또는 용역의 거래를 위하여 "회사"가 제공하는 실시간 전자상거래 시스템과 그 운영을 위한
                    웹사이트로 "회사"의 정책에 따라 추가/변동될 수 있습니다.</li>
                  <li>어플리케이션: "이용자"가 단말기에 내려 받아 설치함으로써 단말기 상에서 "회사"가 제공하는 서비스를
                    이용할 수 있도록 하는 프로그램입니다.</li>
                  <li>이용자: 본 규정에 따라 "회사"가 제공하는 서비스를 이용하는 "회원" 또는 "비회원"을 말합니다.</li>
                  <li>회원: "회사"에 개인정보를 제공하고 "회원"자격을 부여 받은 자로 "회사"의 정보를 지속적으로 제공받으며
                    "회사"에서 제공한 서비스를 이용할 수 있는 자를 말합니다. 만 14세 이상이면 누구나 가입할 수 있습니다.</li>
                  <li>비회원: "회원"에 가입하지 않고 "회사"가 제공하는 정보 및 서비스를 이용하는 자를 말합니다.</li>
                  <li>구매자(대표 예약자): 상품 등을 구입할 의사를 밝힌 "회원"또는 "비회원"중에 개인 또는 단체를 대표하여
                    구매행위를 한 자를 말합니다.</li>
                  <li>판매사(업체): "회사"가 제공하는 중개 판매 서비스를 통하여 상품을 판매할 목적으로 회사와 서비스
                    이용계약을 체결한 자를 말합니다.</li>
                  <li>개인정보: 성명, 생년월일, 전자우편, 휴대전화번호 등 특정 개인을 식별할 수 있는 정보를 말합니다.</li>
                  <li>아이디(ID): "회원"의 식별과 서비스 이용을 위해 "회원"이 직접 입력, 설정하여 "회사" 시스템에
                    등록한 인식 문자를 말합니다.</li>
                  <li>비밀번호(Password): "회원" 본인의 적법한 접근인지를 확인하고 "회원"정보, 거래 내역 등의
                    비밀을 보호하기 위해 "회원"이 직접 입력, 설정하여 "회사" 시스템에 등록한 영문, 숫자, 특수 문자의 조합을
                    말합니다.</li>
                  <li>직접판매 상품: "회사(본사와 지사 포함)"의 "웹사이트" 및 "어플리케이션"을 통하여 직접 판매되는
                    것으로서 타 업체와 연동되지 않은 판매 상품을 말합니다.</li>
                  <li>중개 판매 상품: "회사(본사와 지사 포함)"의 "웹사이트" 및 "어플리케이션"을 통해 "판매사(업체)"의
                    상품과 "구매자"를 중개하는 것으로서, "판매사(업체)"와 연동하여 판매하는 상품을 말합니다.</li>
                  <li>포인트(P): "회사"가 "회사"의 "직접판매 상품"을 구매한 "회원"에게 구매금액의 일정률을 포인트로
                    환산하여 제공하는 서비스를 말하며, "회사"가 정한 방법에 따라 사용할 수 있습니다. "포인트" 세부 방침은 "회사"의
                    정책에 따라 달라질 수 있습니다.</li>
                  <li>할인쿠폰(쿠폰): 상품을 구매할 때 쿠폰에 표시된 금액 또는 비율만큼 구매가격을 할인 받을 수 있는 회사
                    전용의 온라인/모바일 "할인쿠폰"을 말합니다. "할인쿠폰"의 종류 및 내용은 "회사"의 정책에 따라 달라질 수 있습니다.</li>
                  <li>고객 리뷰: 상품 구매 후 해당 상품에 대한 종합적인 평가를 기록한 글, 이미지, 영상물, 평가점수 등의
                    게시물을 말합니다.</li>
                  <li>본인확인: 휴대전화 인증(또는 i-PIN 인증)을 통하여 "회원"이 본인인지 여부를 확인하는 것을
                    의미합니다.</li>
                  <li>영업일: "회사"가 정상적으로 서비스를 제공한 날로서 토요일, 일요일 및 법정 공휴일을 제외한 날을
                    말합니다.</li>
                </ol>
              </li>
            ...
            <ol class="list_circle">
              ...
              <li>② "회사"는 합리적인 사유가 발생하면 약관의 규제에 관한 법률, 전자문서 및 전자거래 기본법, 전자서명법,
                정보통신망 이용촉진 및 정보보호 등에 관한 법률, 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령에 위배되지 않는
                범위 안에서 본 약관을 개정할 수 있습니다.</li>
              <li>③ "회사"가 본 약관을 개정할 때에는 적용일자(이하 "효력발생일") 및 개정사유를 밝혀 그 효력발생일 7일
                전부터 효력발생일 전일까지 "웹사이트" 및 "어플리케이션"에 공지합니다. 단, "이용자"에게 불리하거나 중대한 사항의 변경은
                효력발생일 30일 전부터 공지하며, 이메일(e-mail), 휴대폰 메시지(SMS) 등으로 "회원"에게 개별 통지합니다.
                "회원"의 연락처 미 기재, 변경, 오 기입 등으로 개별 통지가 어려울 때에는 "웹사이트" 및 "어플리케이션"에 공지를 하는
                것을 개별 통지한 것으로 간주합니다.</li>
              <li>④ 이 약관에 동의하는 것은 정기적으로 "회사"가 운영하는 "웹사이트" 및 "어플리케이션"을 방문하여 약관의
                개정사항을 확인하는 것에 동의함을 의미합니다. 개정된 약관에 대한 정보를 알지 못하여 발생하는 "이용자"의 피해에 대해
                "회사"는 책임을 지지 않습니다.</li>
              ...
              <li>⑥ "회원"이 개정 약관의 효력발생일 전까지 반대의사를 표시한 경우, "회사"는 개정 약관의 내용을 적용할 수
            ...
            <ol class="list_circle">
              ...
              <li>③ "회사"는 필요하면 서비스 이용과 관련된 세부적인 내용(이하 "이용 정책")을 정하여 이를 "웹사이트" 및
                "어플리케이션" 등을 통하여 공지할 수 있습니다. 개별약관이나 이용 정책의 변경이 있으면 ＂회사"는 변경 내용의 효력발생일
              ...
              <li>⑤ "이용자"는 항상 개별약관이나 이용 정책의 내용에 변경이 있는지 여부를 주시하여야 하며, 변경사항의 공지가
            ...
            <ol class="list_circle">
              ...
              <li>③ "회사"는 다음 각 호에 해당하는 경우 서비스 제공을 중지 또는 제한할 수 있습니다.
                <ol class="list_number">
                  ...
                  <li>국가 비상사태, 정전, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이
                    있는 경우</li>
                </ol>
              </li>
            </ol>
            ...
            <ol class="list_circle">
              ...
              <li>③ 회원가입의 성립시기는 "회사"의 이용 승낙 의사가 해당 서비스화면에 게시되거나, 이메일(E-mail) 또는
              ...
              <li>⑤ "회사"는 "이용자"의 회원가입 시 필수 항목(아이디, 비밀번호, 휴대폰번호, 이름) 외에 추가적인
                정보(예: 성별, 생년월일, 추천인 아이디 등)를 요청할 수 있으며, 회원가입 신청자는 이러한 추가 정보의 제공을 거절할 수
              ...
              <li>⑧ "회사"의 합리적인 판단에 기하여 회원 신청자의 서비스 이용을 거부할 필요가 있다고 인정할 경우 "회사"는
                회원가입신청을 거부할 수 있습니다.</li>
            </ol>
            <h4 class="tit_sub">제8조(회원 탈퇴 및 자격상실)</h4>
            <ol class="list_circle">
              <li>① "회원"은 "회사"가 정한 방법으로 회원탈퇴를 요청할 수 있으며, "회사"는 요청을 받는 즉시 회원탈퇴를
                처리합니다. 다만, 탈퇴 처리 시점에 "회원"의 구매 계약 절차가 완료되지 않은 경우, "회사"는 해당 구매 계약이 완료된
                후 탈퇴 처리합니다.</li>
              <li>② "회사"는 "회원"이 다음 각 호에 해당하는 행위를 한 경우 사전통지 없이 회원자격을 제한 및 정지하거나,
                기간을 정하여 서비스 이용을 중지할 수 있습니다. 각 호에 해당하는 행위를 한 "회원"이 "구매자"일 경우, "회사"는 해당
                구매 계약을 취소하거나 해지하는 등의 조치를 할 수 있으며, "회원"은 이와 관련하여 "회사"가 입은 직, 간접적인 손해에
                ...
                <ol class="list_number">
                  ...
                  <li>"회사"의 서비스를 이용하여 구입한 상품의 대금, 기타 서비스 이용에 관련하여 회원이 부담하는 채무를
                    기일에 지급하지 않는 경우</li>
                  <li>"회사"가 제공하는 포인트 및 쿠폰 등으로 경제적 이익을 편법으로 수취하고, 이 과정에서 회원 계정을
              ...
              <li>④ "회사"는 본 조 제2항에 의하여 "회원"에 대한 서비스이용을 제한하고자 하는 경우에는 그 사유, 일시 및
                기타사항을 정하여 이 약관 에 따라 "회원"에게 통지합니다. 다만, "회사"가 긴급하게 이용을 정지할 필요가 있다고 판단하는
                경우에는 그러하지 아니합니다.</li>
            ...
            <ol class="list_circle">
              <li>① "회사"가 "회원"에 대하여 통지하는 경우 "회원"이 제출한 이메일 주소 또는 휴대전화로 할 수 있습니다.
                이 경우 "회원"의 통신 환경 또는 요금 구조 등에 따라 "회원"이 통지에 관한 통신비용(데이터 요금 포함) 등을 부담할 수
                있습니다.</li>
              <li>② "회사"는 불특정다수의 "이용자"에게 통지하는 경우, "웹사이트" 및 "어플리케이션"초기화면에 7일 이상
                게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, "회원" 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는
                개별통지를 합니다.</li>
            ...
            <ol class="list_circle">
              ...
              <li>③ 포인트 세부 방침은"회사"가 "웹사이트" 및 "어플리케이션"에 고지하는 "포인트 규정"에 따릅니다.
                "포인트 규정"안내 페이지에서 포인트 세부 방침을 확인할 수 있으며, 이를 확인하지 않아 생긴 손해에 대해서 "회사"는
                책임지지 않습니다.</li>
              <li>④ "회원"이 구매를 취소할 경우, 기 지급된 포인트는 회수 처리 됩니다.</li>
              <li>⑤ "회사"는 "회원"이 제8조(회원 탈퇴 및 자격상실) 혹은 제 25조(금지행위)에 해당하는 행위를 한 경우
                사전통지 없이 포인트 서비스를 제한, 회수, 부정행위에 상응하는 현금 배상 청구 및 필요한 법적 조치를 취할 수 있습니다.
                "회사"는 이로 인한 손해배상책임을 지지 않습니다.</li>
              <li>⑥ "포인트"의 상세 방침은 별도 고지없이 수시 변경될 수 있습니다. "회원"에게 불리한 내용인 경우에는
                제10조의 규정에 따라 공지 또는 통지하며, 효력발생일 이후 서비스 계속 이용 시 동의한 것으로 간주됩니다.</li>
            </ol>
            <h4 class="tit_sub">제12조(포인트 환불 및 이관)</h4>
            <ol class="list_circle">
              <li>① "회원"이 구매를 취소할 경우, "회사"는 해당 구매로 인해 사용된 포인트를 "회원"에게 환불합니다. 단,
                국내∙외 여행 표준약관 또는 특별약관에 따라 별도의 취소위약금이 부가될 경우 "포인트" 환불 금액은 없거나 달라질 수
                있습니다.</li>
            ...
            <ol class="list_circle">
              <li>① 포인트의 유효기간은 아래 각 호와 같으며 유효기간 경과 시 자동 소멸됩니다. "포인트" 유효기간은 휴면회원
              ...
              <li>⑤ 포인트의 유효기간은 "회원"이 "웹사이트" 및 "어플리케이션"에서 직접 확인하여야 하며 포인트의 유효기간
                만료 도래 시 "회사"는 유효기간 만료 30일 이전 잔여 포인트와 유효기간을 제10조 2항에서 정한 방법에 따라 통지합니다.</li>
            </ol>
            ...
            <ol class="list_circle">
              ...
              <li>③ "할인쿠폰"은 이용 가능 품목, 이용가능 구매금액, 총 할인 금액 제한, 이용가능 결제수단 등의 조건이
                상이하게 설정될 수 있으며 이를 사전에 확인하지 않아 발생한 "구매자"의 손해나 손실에 대해 "회사"는 책임지지 않습니다.</li>
              <li>④ "할인쿠폰" 유효기간이 경과한 후에는 해당 "할인쿠폰"을 제공받거나 사용할 수 없습니다.</li>
              <li>⑤ "할인쿠폰"은 "회사"가 별도로 명시한 경우를 제외하고는 "회원"이 임의로 타인에게 매매 또는 양도할 수
                없습니다. 만약 "회원"이 이를 위반한 경우에는 "회사"는 쿠폰을 즉시 회수(쿠폰 소멸 등)하거나 "회사"가 입은 손해에
                대해 "회원에게" 배상을 청구하거나 "회원"의 회원자격을 제한 또는 상실시키는 등의 조치를 취할 수 있습니다.</li>
            ...
            <ol class="list_circle">
              ...
              <li>③ "이용자"는 구매한 상품에 대하여 구매를 취소하거나 변경을 요청할 수 있으며, 이 경우 별도의 취소위약금이
                발생할 수 있습니다.</li>
              ...
              <li>⑦ "회사"는 "이용자"가 구매 계약 체결 내용을 확인할 수 있도록 조치하며, 구매계약의 취소 방법 및 절차를
                안내합니다.</li>
            ...
            <ol class="list_circle">
              <li>① "회사" 의 "웹사이트" 및 "어플리케이션"에서 판매되는 상품을 구매한 "이용자"는 "회사"가 정한 다음
                각 호의 방식 중 하나를 선택하여 대금을 결제할 수 있습니다. 단, 제3호의 포인트 결제는 다른 결제 방식과 함께 사용할 수
                있습니다.
                <ol class="list_number">
            ...
            <ol class="list_circle">
              <li>① "회사"는 "구매자"와 상품의 공급시기에 관하여 별도의 약정이 없는 이상, "구매자"가 청약을 한 날부터
                7일 이내에 상품을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 이때 "회사"는 "구매자"가 상품의
                공급 절차 및 진행사항을 확인할 수 있도록 적절한 조치를 합니다. 여행상품과 같은 용역의 공급은 해당 용역에 적용되는 별도의
                약관을 교부하고 해당 서비스가 차질 없이 진행되도록 일련의 조치를 하여야 합니다.</li>
              <li>② "회사"는 "구매자"가 구매한 상품에 대해 배송수단, 수단별 배송비용 부담자, 수단별 배송기간 등을
                명시합니다. 만약 "회사"가 약정 배송기간을 초과한 경우에는 그로 인한 "이용자"의 손해를 배상하여야 합니다. 다만,
                "회사"가 고의 및 과실이 없음을 입증한 경우에는 그러하지 아니합니다. 여행상품과 같은 용역의 공급은 예약한 상품에 대한
                별도의 "여행자 계약서" 등을 교부하여 "구매자"가 상기 상품의 구매와 이용에 대해 숙지할 수 있도록 하여야 합니다.</li>
              <li>③ 상품의 반품을 신청한 "구매자"는 상품을 즉시 반환하여야 하며, "구매자"가 "회사"에게 해당 상품을
                반환하지 않은 경우에는 상품의 반품 신청 의사를 철회한 것으로 간주합니다.</li>
              <li>④ 상품의 반품에 소요되는 비용은 반품에 대하여 귀책사유 있는 자가 부담합니다. (예: 단순변심의 경우 구매자
            ...
            <ol class="list_circle">
              <li>① "회사"는 "이용자"의 구매신청이 있는 경우 "이용자"에게 수신확인통지를 하며, 수신확인통지를 받은
                "이용자"는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있습니다.
                "회사"는 서비스 제공 전에 "이용자"의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만, 이미
              ...
              <li>③ 취소 시 취소 위약금이 적용되며, 취소 요청 접수 기준은 당사운영시간 내 접수된 시간을 기준으로
                적용됩니다.</li>
              <li>④ 각 상품의 상세페이지 내 별도 규정이 있는 경우 해당 상품의 상세페이지의 정책이 우선 적용됩니다.</li>
              <li>⑤ 미성년자 또는 미성년자의 법정대리인은 민법의 규정에 의하여 미성년자의 구매를 취소할 수 있으나, 미성년자가
                속임수로써 "회사"로 하여금 법정대리인의 동의가 있는 것으로 믿게 한 경우에는 그 취소가 제한됩니다.</li>
            </ol>
            <h4 class="tit_sub">제20조(환불)</h4>
            <ol class="list_circle">
              <li>① "회사"는 "이용자"가 구매 신청한 상품이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체
                없이 그 사유를 "이용자"에게 통지하고 사전에 상품의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환불 및
                환불에 필요한 조치를 취합니다.</li>
              <li>② "구매자"가 반품한 상품은 "회사"가 수령 및 확인한 이후 환불처리가 됩니다.</li>
              <li>③ 여행상품의 경우 상품의 특성 상 "이용자"가 출발일 전 모든 예약이 완료된 이후 계약을 해지할 경우
                국내∙외 여행표준약관 및 소비자 피해보상규정에 의거 손해 배상액을 공제하고 환불하며, 기타 상품의 이용 계약체결 시 계약한
            ...
            <ol class="list_circle">
              <li>① "회사"와 구매 계약을 체결한 "구매자"는 수신확인의 통지를 받은 날부터 7일 이내에는 청약의 철회를 할
                수 있습니다. 단, 국내∙외 여행 표준약관 또는 특별약관에 따라 별도의 취소위약금이 부가될 수 있습니다.</li>
              <li>② "구매자"는 상품을 배송 받은 경우 다음 각호의 어느 하나에 해당하는 경우에는 청약 철회를 할 수
                없습니다.
                <ol class="list_number">
                  <li>구매자에게 책임 있는 사유로 상품이 멸실 또는 훼손된 경우. (다만, 상품의 내용을 확인하기 위하여 포장
              ...
              <li>③ 제2항 2호, 3호 내지 제5호의 경우에 "회사"가 사전에 청약철회 등이 제한되는 사실을 소비자가 쉽게 알
                수 있는 곳에 명기하거나 시용 상품을 제공하는 등의 조치를 하지 않았다면 "구매자"의 청약철회 등이 제한되지 않습니다.</li>
              <li>④ 구매자는 제1항 및 제2항의 규정에 불구하고 상품의 내용이 상세페이지내용과 다르거나 계약 내용과 다르게
                이행된 때에는 당해 상품을 공급받은 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회
                등을 할 수 있습니다.</li>
            </ol>
            <h4 class="tit_sub">제22조(청약철회 등의 효과)</h4>
            <ol class="list_circle">
              <li>① "회사"는 "이용자"로부터 상품을 반환받은 경우 3영업일 이내에 이미 지급받은 상품의 대금을 환급합니다.
                이 경우 "회사"가 "이용자"에게 상품의 환급을 지연한때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한
                법률 시행령」제21조의3에서 정하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.</li>
              <li>② "회사"는 위 대금을 환급함에 있어서 "이용자"가 신용카드 또는 전자화폐 등의 결제수단으로 상품의 대금을
                지급한 때에는 지체 없이 당해 결제수단을 제공한 사업자로 하여금 상품의 대금의 청구를 정지 또는 취소하도록 요청합니다.</li>
              <li>③ 청약철회 등의 경우 공급받은 상품의 반환에 필요한 비용은 "이용자"가 부담합니다. "회사"는 "이용자"에게
                청약철회 등을 이유로 위약금 또는 손해배상을 청구하지 않습니다. 다만 상품의 내용이 표시·광고 내용과 다르거나 계약내용과
                다르게 이행되어 청약철회 등을 하는 경우 상품의 반환에 필요한 비용은 "회사"가 부담합니다.</li>
              <li>④ "이용자"가 상품을 제공받을 때 발송비를 부담한 경우에 "회사"는 청약철회 시 그 비용을 누가 부담하는지를
            ...
            <ol class="list_circle">
              ...
              <li>② "회사"는 "웹사이트" 및 "어플리케이션"을 통해 제공하는 "상품 등"에 대하여 표시·광고의 공정화에 관한
                법률에서 정한 부당한 표시, 광고행위를 하지 않겠습니다.</li>
              <li>③ "회사"는 "웹사이트" 및 "어플리케이션"에 대한 공정하고 건전한 운영을 통하여 전자상거래질서를 유지하고,
            ...
            <ol class="list_circle">
              ...
              <li>② "회원"은 자신의 아이디(ID) 및 비밀번호에 대한 관리 책임을 가지며, 어떠한 경우에도 자신의
                아이디(ID) 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다."회사"의 귀책사유 없이 발생한 ID 및 비밀번호의 유출,
                양도, 대여로 인하여 발생한 손해에 대하여, "회사"는 아무런 책임을 지지 않습니다.</li>
              <li>③ "회원"은 자신의 아이디(ID) 및 비밀번호를 도난 당하거나 제3자가 사용하고 있음을 인지한 경우에는 바로
                "회사"에 통보하고 "회사"의 안내가 있는 경우에는 그에 따라야 합니다.</li>
              <li>④ "회원"은 가입신청 시 사실에 입각하여 정직하고 성실하게 가입신청서를 작성하여야 하며, 기재한 사항에 대한
                변경사유가 발생하는 경우 사실에 맞게 변경해야 합니다. 만일 변경사유가 발생하였음에도 불구하고 변경하지 않아 발생하게 되는
            ...
            <ol class="list_circle">
              ...
              <li>② "이용자"는 타인의 명의나 카드 정보, 계좌정보 등을 도용하여 "회사"가 제공하는 서비스를 이용하는 행위를
                하여서는 안 됩니다.</li>
              <li>③ "이용자"가 본 조를 위반한 경우, "회사"는 해당 "이용자"에 대하여 구매계약을 취소하거나 해지하는 등의
                조치를 취할 수 있으며, "이용자"는 이와 관련하여 "회사"가 입은 모든 직, 간접적인 손해에 대하여 배상 책임을
                부담합니다.</li>
            </ol>
            ...
            <ol class="list_circle">
              ...
              <li>② "회원"은 "웹사이트" 및 "어플리케이션"을 통하여 얻은 정보 중 "회사"에게 지적재산권이 귀속된 정보를
                "회사"의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게
                하여서는 안됩니다.</li>
              <li>③ "이용자"는 "고객 리뷰"및 사진, 글, 정보, (동)영상, "회사"에 대한 의견이나 제안 등 콘텐츠(이하
                '게시물')를 "회사"서비스 내에 게시할 수 있으며, 이러한 게시물에 대한 저작권을 포함한 지적재산권은 "이용자"가 계속하여
                보유합니다.</li>
              <li>④ "이용자"가 "회사"서비스 내에 게시물을 게시하는 경우, 해당 게시물이 "회사’가 제공하는 서비스에 노출될
                수 있고 이에 필요한 범위 내에서 사용, 저장, 수정, 복제, 공중 송신, 전시, 배포 등의 방식으로 이용할 수 있도록
                사용을 허락하는 라이선스를 "회사"에게 제공하게 됩니다. 일부 서비스에서는 "이용자"가 제공한 콘텐츠에 접근하거나 이를 수정
                또는 삭제하는 방법을 제공할 수 있습니다. 또한 "이용자"가 일부 서비스에서는 제공된 콘텐츠에 대한 "회사" 의 사용 범위를
              ...
              <li>⑥ "회사"는 "이용자"가 게시하거나 등록한 게시물이 다음 각 호에 해당된다고 판단되는 경우에 사전통지 없이
                삭제 또는 임시 조치할 수 있고, 이에 대하여 "회사"는 어떠한 책임도 지지 않습니다. 다만, "회사"가 모든 게시물을
                검토할 의무가 있는 것은 아니며, 타인이 "이용자"의 권리를 침해하였다면, 고객센터를 통해 게시중단 요청에 대한 도움을 받을
                수 있습니다.</li>
              <li>⑦ "회사"는 "회원"이 게시하거나 등록한 게시물이 다음 각 호에 해당한다고 판단되는 경우에 사전통지 없이
                ...
                <ol class="list_number">
                  ...
                  <li>타인의 계정정보, 성명 등을 무단으로 도용하여 작성한 내용이거나, 타인이 입력한 정보를 무단으로 위변조한
                    내용인 경우</li>
            ...
            <ol class="list_circle">
              <li>① "회사"는 "이용자"로부터 정보를 수집할 경우 서비스의 제공 및 계약 이행에 필요한 최소한의 정보만을
                수집합니다.</li>
              <li>② "회사"는 서비스 이용 과정에서 "이용자"가 직접 제공한 정보 외에도 개인정보 보호 등 관련 법령에서 정한
                절차에 따라 그 밖의 정보를 수집 및 이용 또는 제3자에게 제공할 수 있습니다. 이 경우 회사는 관련 법령에 따라
                회원으로부터 필요한 동의를 받거나 관련 법령에서 정한 절차를 준수합니다. 링크된 사이트 및 서비스를 제공하는 제3자의
                개인정보 처리에 대해서는 해당 사이트 및 제3자의 개인정보처리방침을 확인할 책임이 "이용자"에게 있으며, 회사는 이에 대하여
                책임을 부담하지 않습니다.</li>
            ...
            <ol class="list_circle">
              <li>① "회사"는 통신판매중개자로서 "구매자"와 "판매사" 간의 자유로운 상품의 거래를 위한 시스템 운영 및 관리
                책임만을 부담하며, "구매자 또는 "판매사"를 대리하지 아니하고, "이용자" 간에 성립된 거래와 관련된 책임과 "구매자"가
                등록한 정보에 대한 책임은 해당 "구매자"가 직접 부담하여야 합니다.</li>
              <li>② "회사"는 "웹사이트" 및 "어플리케이션"을 통하여 이루어지는 "구매자"와 "판매사" 간의 거래와 관련하여
                판매 의사 또는 구매 의사의 존부 및 진정성, 등록 상품의 품질, 완전성, 안정성, 적법성 및 타인의 권리에 대한 비침해성,
                "구매자" 또는 "판매사"가 입력하는 정보 및 그 정보를 통하여 링크된 URL에 게재된 자료의 진실성 또는 적법성 등 일체를
                보증하지 않습니다. 다만, 등록된 상품 또는 용역 관련된 정보가 법규 위반이나 저작권 침해가 명백한 경우, 또는 저작권 등
                권리를 침해 받았다고 주장하는 자가 그 침해의 정지ㆍ예방을 요청하는 경우 회사는 당사자간의 분쟁이 해결되어 권리관계가
                명확해질 때까지 해당 상품에 대한 삭제, 수정 또는 미 노출 처리할 수 있습니다.</li>
              <li>③ "회사"는 "구매자"와 "판매사"간의 거래의 안전성과 신뢰성을 높이는 도구만을 개발하여 제공합니다. 단,
                "회사"의 "직접 판매 상품"의 경우 "구매자"에 대하여 "회사"는 "판매사"의 지위를 갖게 됩니다.</li>
            </ol>
            <h4 class="tit_sub">제29조 (연결"회사"와 피 연결"회사" 간의 관계)</h4>
            <ol class="list_circle">
              <li>① 상위 "회사"와 하위 "회사"는 하이퍼링크(예: 하이퍼링크의 대상에는 문자, 그림 및 동화상 등이
                포함)방식 등으로 연결된 경우, 전자를 연결"회사"(웹사이트)라고 하고 후자를 피연결"회사"(웹사이트)라고 합니다.</li>
              <li>② 연결"회사"는 피연결"회사"가 독자적으로 제공하는 상품에 의하여 "이용자"와 행하는 거래에 대해서 보증
                책임을 지지 않는다는 뜻을 연결"회사"의 초기화면 또는 연결되는 시점에 명시한 경우에는 그 거래에 대한 보증 책임을 지지
                않습니다.</li>
            </ol>
            ...
            <ol class="list_circle">
              ...
              <li>④ "회사"는 "회원"이 게재한 게시물(이용후기, 숙소평가 등 포함)의 정확성 등 내용에 대하여는 책임을 지지
                않습니다.</li>
              ...
              <li>⑥ 중개 판매 상품은 "판매사"의 책임 하에 관리∙운영되고, "회사"는 통신판매중개자로서 서비스 운영 상의
                문제를 제외한 상품의 하자∙부실 등으로 인한 책임은 "판매사"에게 귀속되며 "회사"는 어떠한 책임도 부담하지 않습니다.
                "구매자"와 "판매사" 사이에 성립된 거래와 관련된 책임 등은 "판매사"와 "구매자"가 직접 부담하여야 합니다.</li>
              <li>⑦ "회사"는 제3자가 서비스 내 화면 또는 링크된 웹사이트를 통하여 광고한 제품 또는 서비스의 내용과 품질에
              ...
              <li>⑧ "회사"는 "회사" 및 "회사"의 임직원 그리고 "회사" 대리인의 고의 또는 중대한 과실이 없는 한 다음
                ...
                <ol class="list_number">
                  ...
                  <li>서버에 대한 전송 또는 서버로부터의 전송에 대한 제3자의 모든 불법적인 방해 또는 중단행위로부터 발생하는
                    손해</li>
                  <li>제3자가 서비스를 이용하여 불법적으로 전송, 유포하거나 또는 전송, 유포되도록 한 모든 바이러스,
                    스파이웨어 및 기타 악성 프로그램으로 인한 손해</li>
                  <li>전송된 데이터의 오류 및 생략, 누락, 파괴 등으로 발생되는 손해</li>
                  <li>"회원"간의 "회원" 상태 정보 등록 및 서비스 이용 과정에서 발생하는 명예훼손 기타 불법행위로 인한 각종
                    민∙형사상 책임</li>
                </ol>
              </li>
              <li>⑨ 상품의 특성이나 상품 제공업체의 환불규정이 "회사"의 취소환불 규정에 우선한 결과 위
                '소비자분쟁해결기준'과는 다르게 배상되는 경우, "회사"는 이에 관하여 일체의 책임을 지지 않습니다.</li>
            </ol>
            ...
            <ol class="list_circle">
              ...
              <li>② "회사"에서 정하는 규정과 관련된 모든 분쟁은 제소 당시 "이용자"의 주소에 의하고, 주소가 없는 경우에는
                거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 "이용자"의 주소 또는 거소가 분명하지 않거나 외국 거주자의
