		...
		<div id="div001">
			<div id="div001_in01">
				<div id="div001_in01_in01">
					...
					<% String u_id=(String) session.getAttribute("u_id"); // 미로그인 시, if(u_id==null){%>
						...
						<%} // 로그인 성공 시, else{%>
							...
							<a href="<%=request.getContextPath() %>/user/myPageInfo.do?u_id=${member.u_id}">회원정보
								&nbsp;</a>
							<a href="<%=request.getContextPath()%>/user/cs.do">고객센터&nbsp;</a>
							<a href="<%=request.getContextPath()%>/wishlist/list.do?u_id=${member.u_id }">찜&nbsp;</a>
							<a href="<%=request.getContextPath()%>/userRes/list.do?u_id=${member.u_id}">예약조회&nbsp;</a>
				...
				<div id="div001_in01_in02">
					<div id="div001_in01_in02_in01"><img src="http://jjcom0214.cafe24.com/web/OneTrillion/search3.png"
							alt=""></div>
				</div>
			</div>
		</div>
