        ...
        <div style="float:right; width: 1500px;height: auto;">
            <div
				...
				<table id="adminMemtable1" style="width: 100%; border-top: 2px solid #343a40;">
                    <tr>
                        <th>REPLY_SEQ</th>
                        <td><input type="text" class="form-control" name="reply_seq"  value = "${replyDetail.reply_seq}"></td>
                    </tr>
                    <tr>
                        <th>U_ID</th>
                        <td><input type="text" class="form-control" name="u_id"  value = "${replyDetail.u_id}"></td>
                    </tr>
                    <tr>
                        <th>PD_SEQ</th>
                        <td><input type="text" class="form-control" name="pd_seq"  value = "${replyDetail.pd_seq}"></td>
                    </tr>
                    <tr>
                        <th>REPLY_TITLE</th>
                    ...
                    <tr>
                        ...
                        <td><textarea class="form-control" id="exampleFormControlTextarea1" rows="4"
                                 name="reply_content"
                                style="border:0; resize: none; background-color: white;">${replyDetail.reply_content}</textarea></td>
                    </tr>
                    <tr>
                        <th>REPLY_RATE</th>
                        <td><input type="text" class="form-control"  name="reply_rate"  value = "${replyDetail.reply_rate}"></td>
                    </tr>
                </table>
