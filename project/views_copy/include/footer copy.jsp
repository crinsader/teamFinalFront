    ...
    <body>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-bs-toggle="modal"
                                data-bs-target="#exampleModal01">개인정보처리방침</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-bs-toggle="modal"
                                data-bs-target="#exampleModal02">이용약관</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-bs-toggle="modal"
                                data-bs-target="#exampleModal03">여행약관</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <table style="width: 100%; height: 100%;">
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <img src="http://jjcom0214.cafe24.com/web/OneTrillion/logo-last1.png" alt="logo"
                                height="200px">
                        </td>
                    </tr>
                </table>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <iframe src="../compony/agreeFoot.jsp" frameborder="0"
                            style="width: 100%; height:70vh; border-radius: 0 0 20px 20px;"></iframe>
                    </div>
        ...
        <div class="modal fade" id="exampleModal03" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">여행약관</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <iframe src="../compony/agreeFoot.jsp" frameborder="0"
