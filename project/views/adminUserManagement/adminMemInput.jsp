        ...
        <div style="float:right; width: 1500px;height: auto;">
            <div
                ...
                <table id="adminMemtable1" style="width: 100%; border-top: 2px solid #343a40;">
                    <tr>
                        <th>U_ID</th>
                        <td><input type="text" class="form-control" placeholder="U_ID" name="u_id"></td>
                    </tr>
                    <tr>
                        <th>U_PWD</th>
                        <td><input type="password" class="form-control" placeholder="U_PWD" name="u_pwd"></td>
                    </tr>
                    <tr>
                        <th>U_NICKNAME</th>
                        <td><input type="text" class="form-control" placeholder="U_NICKNAME" name="u_nickName"></td>
                    </tr>
                    <tr>
                        <th>U_EMAIL</th>
                        <td><input type="text" class="form-control" placeholder="U_EMAIL" name="u_email"></td>
                    </tr>
                </table>
