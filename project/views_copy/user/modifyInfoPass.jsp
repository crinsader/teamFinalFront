	...
	<div style="margin: auto; width: 1100px; height: 800px;">
		<div class="list-group" style="float: left; width: 180px; height: 600px; margin-top: 40px;">
			...
			<a href="#" class="list-group-item list-group-item-action"
				style="background-color: #343a40; color: white;">개인정보</a> <a href="#"
				class="list-group-item list-group-item-action">1대1문의</a> <a href="#"
				class="list-group-item list-group-item-action">찜 내역</a> <a href="#"
				class="list-group-item list-group-item-action">예약내역</a> <a href="#"
			...
			<div class="myPageMenu2" id="myPageinfo1">
				...
				<div class="passdiv03">
					<form action="modifyInfoPass" method="post">
						...
						<div class="form-group row" style="margin-left: 50px; margin-top: 80px; width: 500px;">
							<label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
							<div class="col-sm-7">
								<input type="text" style="margin-left: 20px;" readonly class="form-control-plaintext"
									id="staticEmail" value="${member.u_id }">
							</div>
						</div>
						<div class="form-group row" style="margin-left: 50px; margin-top: 10px; width: 500px;">
							<label for="inputPassword" class="col-sm-2 col-form-label">Password</label>
							<div class="col-sm-7">
								<input type="password" name="u_pwd" style="margin-left: 20px;" class="form-control"
