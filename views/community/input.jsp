                            ...
                            <div>
                                <nav class="navbar-dark bg-dark"
                                    ...
                                    <a class="navbar-brand" style="font-size: 100%; margin-left: 20px;"
                                        ...
                                        class="navbar-brand" style="font-size: 100%;" href="#">게시글 등록</a>
                                </nav>
                            </div>
       <!--@@ input form @@ 한보영    ------------------------------------------------------------------------------------>                     
                         <form action="input.do" method="post"  id="form">   
                            <table id="priQueTab1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 70%;">${member.u_id}<input type="hidden" value="${member.u_id}" name="u_id" id="u_id"></td>
                                </tr>
                                <tr>
                                    <th>제 목</th>
                                    <td><input type="text" class="form-control" 
                                            style="border: 0; height: 60px;" name="com_title" id="com_title"></td>
                                </tr> 
                                <tr>
                                    <th>내용</th>
                                    <td>
                                        <textarea class="form-control" id="com_content" rows="10"
                                            style="border: 0;"  name="com_content"></textarea>
                                    </td>
                                </tr>
                            </table>
                        		 ...
                        		 console.log( $('#com_content').val()) 
                        	   	 ...
                        	   	 if($('#com_title').val() == ''){ //제목
                            		 ...
                            		 alert('문의 내용을 입력해주세요')
                            			...
                            			var seqdata ={"u_id":$('#u_id').val() 
                            						,  "com_title":$('#com_title').val() 
                            						, "com_content":content};
                            		    $.ajax({
                            		        url:"input.do",
                            		        type:'POST',
