        ...
        <%}%>
          ...
          <div style="margin: auto;width:915px;">
            ...
            <table class="resDetailTab1" style="width: 100%; margin-top: 40px;">
              ...
              <tr>
                <th colspan="2">상품명</th>
                <td class="resDetNoMemTd1" colspan="2" onclick="">${상품명}클릭시 상품 Detail페이지로 넘어가도록 설정</td>
              </tr>
              <tr>
                <th colspan="2">상품번호</th>
                <td class="resDetNoMemTd1" colspan="2" onclick="">${상품번호}클릭시 상품 Detail페이지로 넘어가도록 설정</td>
              </tr>
              <tr>
                <th colspan="2">여행기간</th>
                <td colspan="2">${startDate} ~ ${endDate}</td>
              </tr>
              <tr>
