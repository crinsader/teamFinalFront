                    ...
                    <tr>
                        <td>
                            <div>
                                ...
                                <p style="margin-bottom: 10px;"><strong>$ID</strong>님의 회원가입을 축하합니다</p>
                                <p style="margin-bottom: 20px;">좋은 서비스로 보답하겠습니다</p>
                                <hr style="width: 600px;margin-left: 100px; ">
                                <button type="button" class="btn btn-success">홈으로</button><button type="button"
                                    class="btn btn-primary" onClick="location.href='login.html'">로그인</button>
                            </div>
                        </td>
                    </tr>
                </table>
