...
<style>
*{margin: 0; padding: 0;}
.tit_con_title, .tit_skip{margin-top: 30px;}
.tit_sub{margin-top: 20px;}
.list_number{margin-top: 10px;}
.list_number, .list_nostyle{margin-top: 10px; list-style: none;}
#tripAgFdiv01 p{margin-top: 10px;}
#tripAgFdiv02 p{margin-top: 10px;}
.list_number li, .list_nostyle li{margin-left: 40px; text-indent: -20px;}
#tripAgFdiv01{display: none;}
.tripSpan01:hover{color: red; cursor: pointer;}
</style>
<script>
$(document).ready(function(){
	$(".tripSpan01").on("click", function(){
	if($("#tripAgFdiv01").css("display") == "none"){
		$("#tripAgFdiv01").css("display", "block")
		$("#tripAgFdiv02").css("display", "none")
	}else{
		$("#tripAgFdiv01").css("display", "none")
		$("#tripAgFdiv02").css("display", "block")
	}
	})
})
</script>
<body>
	...
	<div style="margin: auto; width: 1100px;">
		<h2 class="tit_con_title">여행약관</h3>
		(<span class="tripSpan01">국내/국외</span>)
		<p class="txt_nor_info" style="text-align: right;">
			<em class="txt_normal emp_black">공정거래위원회 표준약관 제10021호,
				2019년 08월 30일 개정</em>
		</p>
	</div>
						<div id="tripAgFdiv01" style="margin: auto; width: 1100px;">
							<h3 class="tit_skip">국외 여행약관</h3>
							<h4 class="tit_sub">제1조(목적)</h4>
							<p>이 약관은 OneTrillion 여행사와 여행자가 체결한 국외여행계약의 세부이행 및 준수사항을 정함을 목적으로
								합니다.</p>
							<h4 class="tit_sub">제2조(용어의 정의)</h4>
							<p>여행의 종류 및 정의, 해외여행수속대행업의 정의는 다음과 같습니다.</p>
							<ol class="list_number">
								<li>기획 여행 : 여행사가 미리 여행목적지 및 관광일정, 여행자에게 제공될 운송 및 숙식서비스
									내용(이하 ‘여행서비스’라 함), 여행요금을 정하여 광고 또는 기타 방법으로 여행자를 모집하여 실시하는 여행.</li>
								<li>희망 여행 : 여행자(개인 또는 단체)가 희망하는 여행조건에 따라 여행사가 운송․숙식․관광 등
									여행에 관한 전반적인 계획을 수립하여 실시하는 여행.</li>
								<li>해외여행 수속대행(이하 ‘수속대행계약’이라 함) : 여행사가 여행자로부터 소정의 수속대행요금을
									받기로 약정하고, 여행자의 위탁에 따라 다음에 열거하는 업무(이하 ‘수속대행업무’라 함)를 대행하는 것.
							...
							<h4 class="tit_sub">제5조(계약체결의 거절)</h4>
							...
							<p>여행사는 여행자와 여행계약을 체결한 경우 계약서와 약관 및 여행일정표(또는 여행설명서)를 각 1부씩
							...
							<h4 class="tit_sub">제9조(여행사의 책임)</h4>
							<p>여행사는 여행 출발시부터 도착시까지 여행사 본인 또는 그 고용인, 현지여행사 또는 그 고용인 등(이하
								‘사용인’이라 함)이 제3조제1항에서 규정한 여행사 임무와 관련하여 여행자에게 고의 또는 과실로 손해를 가한 경우
								책임을 집니다.</p>
							<h4 class="tit_sub">제10조(여행요금)</h4>
							<ol class="list_nostyle">
								...
								<li>② 제1항에도 불구하고 반드시 현지에서 지불해야 하는 경비가 있는 경우 그 내역과 금액을
									여행계약서에 별도로 구분하여 표시하고, 여행사는 그 사유를 안내하여야 합니다</li>
								<li>③ 여행자는 계약체결시 계약금(여행요금 중 10%이하 금액)을 여행사에게 지급하여야 하며, 계약금은
									여행요금 또는 손해배상액의 전부 또는 일부로 취급합니다.</li>
								<li>④ 여행자는 제1항의 여행요금 중 계약금을 제외한 잔금을 여행출발 7일전까지 여행사에게 지급하여야
									합니다.</li>
							...
							<h4 class="tit_sub">제11조(여행요금의 변경)</h4>
							<ol class="list_nostyle">
								<li>① 국외여행을 실시함에 있어서 이용운송․숙박기관에 지급하여야 할 요금이 계약체결시보다 5%이상
									증감하거나 여행요금에 적용된 외화환율이 계약체결시보다 2% 이상 증감한 경우 여행사 또는 여행자는 그 증감된 금액
									범위 내에서 여행요금의 증감을 상대방에게 청구할 수 있습니다.</li>
								<li>② 여행사는 제1항의 규정에 따라 여행요금을 증액하였을 때에는 여행출발일 15일전에 여행자에게
									통지하여야 합니다.</li>
							</ol>
							<h4 class="tit_sub">제12조(여행조건의 변경요건 및 요금 등의 정산)</h4>
							<ol class="list_nostyle">
								...
								<li>④ 제1항의 여행조건 변경 및 제11조의 여행요금 변경으로 인하여 제10조 제1항의 여행요금에
									증감이 생기는 경우에는 여행출발 전 변경 분은 여행출발 이전에, 여행 중 변경 분은 여행종료 후 10일 이내에
									각각 정산(환급)하여야 합니다.</li>
								<li>⑤ 제1항의 규정에 의하지 아니하고 여행조건이 변경되거나 제16조 내지 제18조의 규정에 의한
							...
							<h4 class="tit_sub">제13조(여행자 지위의 양도)</h4>
							<ol class="list_nostyle">
							...
							<h4 class="tit_sub">제14조(여행사의 하자담보 책임)</h4>
							<ol class="list_nostyle">
							...
							<h4 class="tit_sub">제15조(손해배상)</h4>
							<ol class="list_nostyle">
								<li>① 여행사는 현지여행사 등의 고의 또는 과실로 여행자에게 손해를 가한 경우 여행사는 여행자에게
									손해를 배상하여야 합니다.</li>
								<li>② 여행사의 귀책사유로 여행자의 국외여행에 필요한 사증, 재입국 허가 또는 각종 증명서 등을
									취득하지 못하여 여행자의 여행일정에 차질이 생긴 경우 여행사는 여행자로부터 절차대행을 위하여 받은 금액 전부 및
									그 금액의 100%상당액을 여행자에게 배상하여야 합니다.</li>
								<li>③ 여행사는 항공기, 기차, 선박 등 교통기관의 연발착 또는 교통체증 등으로 인하여 여행자가 입은
									손해를 배상하여야 합니다. 다만, 여행사가 고의 또는 과실이 없음을 입증한 때에는 그러하지 아니합니다.</li>
								<li>④ 여행사는 자기나 그 사용인이 여행자의 수하물 수령, 인도, 보관 등에 관하여 주의를
									해태(懈怠)하지 아니하였음을 증명하지 아니하면 여행자의 수하물 멸실, 훼손 또는 연착으로 인한 손해를 배상할
									책임을 면하지 못합니다.</li>
							</ol>
							<h4 class="tit_sub">제16조(여행출발 전 계약해제)</h4>
							<ol class="list_nostyle">
								...
								<li>② 여행사 또는 여행자는 여행출발 전에 다음 각 호의 1에 해당하는 사유가 있는 경우 상대방에게
									...
									<ol class="list_number">
										<li>여행사가 해제할 수 있는 경우
											<ol class="list_nostyle">
												<li>가. 제12조 제1항 제1호 및 제2호 사유의 경우</li>
										...
										<li>여행자가 해제할 수 있는 경우
											<ol class="list_nostyle">
												<li>가. 제12조 제1항 제1호 및 제2호의 사유가 있는 경우</li>
												<li>나. 여행사가 제21조에 따른 공제 또는 보증보험에 가입하지 아니 하였거나 영업보증금을
													예치하지 않은 경우</li>
												<li>다. 여행자의 3촌 이내 친족이 사망한 경우</li>
												<li>라. 질병 등 여행자의 신체에 이상이 발생하여 여행에의 참가가 불가능한 경우</li>
												<li>마. 배우자 또는 직계존비속이 신체이상으로 3일 이상 병원(의원)에 입원하여 여행 출발
													전까지 퇴원이 곤란한 경우 그 배우자 또는 보호자 1인</li>
												<li>바. 여행사의 귀책사유로 계약서 또는 여행일정표(여행설명서)에 기재된 여행일정대로의
													여행실시가 불가능해진 경우</li>
												<li>사. 제10조제1항의 규정에 의한 여행요금의 증액으로 인하여 여행 계속이 어렵다고 인정될
													경우</li>
											</ol>
										</li>
									</ol>
							...
							<h4 class="tit_sub">제17조(최저행사인원 미 충족시 계약해제)</h4>
							<ol class="list_nostyle">
								<li>① 여행사는 최저행사인원이 충족되지 아니하여 여행계약을 해제하는 경우 여행출발 7일전까지 여행자에게
									통지하여야 합니다.</li>
								<li>② 여행사가 여행참가자 수 미달로 전항의 기일내 통지를 하지 아니하고 계약을 해제하는 경우 이미
							...
							<h4 class="tit_sub">제18조(여행출발 후 계약해지)</h4>
							<ol class="list_nostyle">
							...
							<h4 class="tit_sub">제19조(여행의 시작과 종료)</h4>
							<p>여행의 시작은 탑승수속(선박인 경우 승선수속)을 마친 시점으로 하며, 여행의 종료는 여행자가 입국장
								보세구역을 벗어나는 시점으로 합니다. 다만, 계약내용상 국내이동이 있을 경우에는 최초 출발지에서 이용하는 운송수단의
								출발시각과 도착시각으로 합니다.</p>
							<h4 class="tit_sub">제20조(설명의무)</h4>
							<p>여행사는 계약서에 정하여져 있는 중요한 내용 및 그 변경사항을 여행자가 이해할 수 있도록 설명하여야
								합니다.</p>
							<h4 class="tit_sub">제21조(보험가입 등)</h4>
							<p>여행사는 이 여행과 관련하여 여행자에게 손해가 발생한 경우 여행자에게 보험금을 지급하기 위한 보험 또는
								공제에 가입하거나 영업보증금을 예치하여야 합니다.</p>
							<h4 class="tit_sub">제22조(기타사항)</h4>
							<ol class="list_nostyle">
								<li>① 이 계약에 명시되지 아니한 사항 또는 이 계약의 해석에 관하여 다툼이 있는 경우에는 여행사 또는
									여행자가 합의하여 결정하되, 합의가 이루어지지 아니한 경우에는 관계법령 및 일반관례에 따릅니다.</li>
								<li>② 특수지역에의 여행으로서 정당한 사유가 있는 경우에는 이 표준약관의 내용과 달리 정할 수
									있습니다.</li>
							</ol>
						</div>
...
<!------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
						...
						<div id="tripAgFdiv02" style="margin: auto; width: 1100px;">
							<h3 class="tit_skip">국내 여행약관</h3>
							<h4 class="tit_sub">제1조(목적)</h4>
